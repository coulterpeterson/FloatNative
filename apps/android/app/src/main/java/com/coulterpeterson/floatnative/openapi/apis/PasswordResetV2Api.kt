...
interface PasswordResetV2Api {
     ...
     */
    @POST("api/v2/user/password/reset")
    suspend fun resetPassword(): Response<kotlin.Any>
     ...
     */
    @POST("api/v2/user/password/reset/request")
    suspend fun sendPasswordReset(): Response<kotlin.Any>
     ...
     */
    @POST("api/v2/user/password/reset/validate")
    suspend fun validateKey(): Response<kotlin.Any>
