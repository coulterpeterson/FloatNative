...
interface ACPFeatureV2Api {
     ...
     */
    @GET("api/acp/v2/feature/configs")
    suspend fun getFeatureConfigs(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/feature/save")
    suspend fun saveFeature(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/feature/category/save")
    suspend fun saveFeatureCategory(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/feature/dependencies/save")
    suspend fun saveFeatureDependencies(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/feature/resolution/save")
    suspend fun saveFeatureResolution(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/feature/type/save")
    suspend fun saveFeatureType(): Response<kotlin.Any>
