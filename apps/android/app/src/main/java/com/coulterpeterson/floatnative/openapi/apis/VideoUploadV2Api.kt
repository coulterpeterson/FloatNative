...
interface VideoUploadV2Api {
    ...
    @POST("api/v2/video/upload/s3/multipart/abort")
    suspend fun abortMultipartUploadV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @POST("api/v2/video/upload/s3/multipart/complete")
    suspend fun completeMultipartUploadVideo(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @POST("api/v2/video/upload/s3/multipart")
    suspend fun createMultipartUploadV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @GET("api/v2/video/upload/s3/multipart")
    suspend fun getUploadedPartsV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @GET("api/v2/video/upload/s3/multipart/sign")
    suspend fun signPartUploadVideo(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @POST("api/v2/video/upload/thumbnail")
    suspend fun uploadThumbnailV2(): Response<kotlin.Any>
