...
interface ACPDashboardV2Api {
     ...
     */
    @GET("api/acp/v2/dashboard/job/status/")
    suspend fun getJobStatus(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/dashboard/job/start/")
    suspend fun startJob(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/dashboard/job/stop/")
    suspend fun stopJob(): Response<kotlin.Any>
