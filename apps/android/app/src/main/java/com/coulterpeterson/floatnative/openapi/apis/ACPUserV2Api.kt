...
interface ACPUserV2Api {
     ...
     */
    @POST("api/acp/v2/user/subscription/add")
    suspend fun addUserSubscriptions(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/user/email/availability")
    suspend fun checkEmailAvailable(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/user/username/availability")
    suspend fun checkUsernameAvailable(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/user/admin/create")
    suspend fun createAdmin(): Response<kotlin.Any>
    ...
    @POST("api/acp/v2/user/delete")
    suspend fun deleteUser(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @GET("api/acp/v2/user/find")
    suspend fun findUser(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/user/payment/processor/data")
    suspend fun getPaymentProcessorData(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/user/")
    suspend fun getUserDetails(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/user/list")
    suspend fun getUserList(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/user/usersubscription/list")
    suspend fun getUserSubscriptions(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/user/payment/invoice/list")
    suspend fun listUserInvoices(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/user/usersubscription/delete")
    suspend fun removeUserSubscription(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/user/list/notmoderator")
    suspend fun searchUserForModeration(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/user/create")
    suspend fun signupACP(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/user/administrator/update")
    suspend fun updateAdministrator(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/user/edit")
    suspend fun updateUser(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/user/avatar/upload")
    suspend fun uploadAvatarACP(): Response<kotlin.Any>
