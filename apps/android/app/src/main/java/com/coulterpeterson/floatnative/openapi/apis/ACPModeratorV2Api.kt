...
interface ACPModeratorV2Api {
     ...
     */
    @POST("api/acp/v2/moderator/creator/add/")
    suspend fun addCreatorModeratorACP(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/moderator/create")
    suspend fun createModerator(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/moderator/creator/available")
    suspend fun getModeratorAvailableCreators(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/moderator/creator/list/")
    suspend fun getModeratorCreators(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/moderator/list")
    suspend fun getModeratorList(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/moderator/creator/remove")
    suspend fun removeCreatorModeratorACP(): Response<kotlin.Any>
     ...
     */
    @POST("api/acp/v2/moderator/update/global")
    suspend fun updateGlobalModerator(): Response<kotlin.Any>
