...
import com.coulterpeterson.floatnative.openapi.models.EdgesModel
import com.coulterpeterson.floatnative.openapi.models.ErrorModel

interface EdgesV2Api {
    /**
     * GET api/v2/edges
     * Get Edges
    ...
    @GET("api/v2/edges")
    suspend fun getEdges(): Response<EdgesModel>
    ...
    @Deprecated("This api was deprecated")
    @GET("api/v2/video/url")
    suspend fun getVideoUrl(): Response<kotlin.Any>
