...
interface CreatorPlanFeatureLevelsV2Api {
    /**
     ...
     */
    @GET("api/v2/creatorplanfeaturelevel/cost")
    suspend fun calculateCreatorPlanFeatureCosts(): Response<kotlin.Any>
     ...
     */
    @GET("api/v2/creatorplanfeaturelevel/list")
    suspend fun listCreatorPlanFeatureLevels(): Response<kotlin.Any>
     ...
     */
    @GET("api/v2/plan/feature/list")
    suspend fun planFeatureLevels(): Response<kotlin.Any>
