...
interface VideoCommentsV2Api {
    ...
    @POST("api/v2/video/comment")
    suspend fun addVideoComment(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @GET("api/v2/video/comment/replies")
    suspend fun getVideoCommentReplies(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @GET("api/v2/video/comments")
    suspend fun getVideoComments(): Response<kotlin.Any>
