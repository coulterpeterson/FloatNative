...
interface WebNotificationV2Api {
    /**
    ...
    @GET("api/v2/push/web/info")
    suspend fun getAppInfoV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @GET("api/v2/push/web/tokenInfo")
    suspend fun getTokenInfo(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @POST("api/v2/push/web/register")
    suspend fun registerV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @POST("api/v2/push/web/revoke")
    suspend fun unregisterV2(): Response<kotlin.Any>
