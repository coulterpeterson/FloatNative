...
interface CMSContentV3Api {
     ...
     */
    @POST("api/cms/v3/content/delete")
    suspend fun deleteContent(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/content/edit")
    suspend fun editContent(): Response<kotlin.Any>
     ...
     */
    @GET("api/cms/v3/content/audio/")
    suspend fun getAudioContentCMS(): Response<kotlin.Any>
    ...
    @GET("api/cms/v3/content/")
    suspend fun getContentCMS(): Response<kotlin.Any>
     ...
     */
    @GET("api/cms/v3/content/gallery/")
    suspend fun getGalleryContentCMS(): Response<kotlin.Any>
     ...
     */
    @GET("api/cms/v3/content/picture/")
    suspend fun getPictureContentCMS(): Response<kotlin.Any>
     ...
     */
    @GET("api/cms/v3/content/video/")
    suspend fun getVideoContentCMS(): Response<kotlin.Any>
     ...
     */
    @GET("api/cms/v3/content/audio/list")
    suspend fun listAudioContent(): Response<kotlin.Any>
     ...
     */
    @GET("api/cms/v3/content/gallery/list")
    suspend fun listGalleryContent(): Response<kotlin.Any>
     ...
     */
    @GET("api/cms/v3/content/picture/list")
    suspend fun listPictureContent(): Response<kotlin.Any>
     ...
     */
    @GET("api/cms/v3/content/video/list")
    suspend fun listVideoContent(): Response<kotlin.Any>
