...
interface ACPCreatorAgreementV2Api {
    /**
     ...
     */
    @GET("api/acp/v2/creatoragreement/edit")
    suspend fun editCreatorAgreement(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/creatoragreement")
    suspend fun getCreatorAgreement(): Response<kotlin.Any>
     ...
     */
    @GET("api/acp/v2/creatoragreement/list")
    suspend fun listCreatorAgreement(): Response<kotlin.Any>
