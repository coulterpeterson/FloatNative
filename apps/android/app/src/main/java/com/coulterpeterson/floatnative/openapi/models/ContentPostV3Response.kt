...
import com.coulterpeterson.floatnative.openapi.models.AudioAttachmentModel
...
import com.coulterpeterson.floatnative.openapi.models.PictureAttachmentModel
 ...
 * @param thumbnail 
 * @param videoAttachments May be undefined when the post is locked.
...
data class ContentPostV3Response (
    ...
    @Json(name = "type")
    val type: ContentPostV3Response.Type,
    ...
    val userInteraction: kotlin.collections.List<ContentPostV3Response.UserInteraction>?,
    ...
    val videoAttachments: kotlin.collections.List<VideoAttachmentModel>? = null,

    /* May be undefined when the post is locked. */
    @Json(name = "audioAttachments")
    val audioAttachments: kotlin.collections.List<AudioAttachmentModel>? = null,

    /* May be undefined when the post is locked. */
    @Json(name = "pictureAttachments")
    val pictureAttachments: kotlin.collections.List<PictureAttachmentModel>? = null,
