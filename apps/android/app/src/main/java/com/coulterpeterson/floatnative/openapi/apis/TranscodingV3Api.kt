...
interface TranscodingV3Api {
     ...
     */
    @GET("api/cms/v3/processing/active")
    suspend fun getActiveProcesses(): Response<kotlin.Any>
    ...
    @POST("api/cms/v3/transcode/subscribe")
    suspend fun progressSubscribeCMS(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @POST("api/cms/v3/transcode/unsubscribe")
    suspend fun progressUnsubscribeCMS(): Response<kotlin.Any>
