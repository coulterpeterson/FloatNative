...
interface ModerationV2Api {
    ...
    @POST("api/v2/moderation/user/ban")
    suspend fun banUserV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @POST("api/v2/moderation/comment/hide")
    suspend fun hideCommentV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @GET("api/v2/moderation/user/ban/list")
    suspend fun listBanV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @POST("api/v2/comment/moderate/")
    suspend fun moderateVideoComment(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @POST("api/v2/moderation/user/unban")
    suspend fun unbanUserV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @POST("api/v2/moderation/comment/unhide")
    suspend fun unhideCommentV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @GET("api/v2/moderator/userBanStatus")
    suspend fun userBanStatusV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @GET("api/v2/moderation/user/info")
    suspend fun userInfoV2(): Response<kotlin.Any>
    ...
    @Deprecated("This api was deprecated")
    @POST("api/v2/moderator/user/unban")
    suspend fun userUnbanV2(): Response<kotlin.Any>
