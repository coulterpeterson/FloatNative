...
interface CMSCreatorWarehouseV3Api {
    /**
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/pricerule/create")
    suspend fun createPriceRule(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/pricerule/delete")
    suspend fun deletePriceRule(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/pricerule/edit")
    suspend fun editPriceRule(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/collections/get")
    suspend fun getCollections(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/countries/get")
    suspend fun getCountries(): Response<kotlin.Any>
     ...
     */
    @GET("api/cms/v3/creatorwarehouse")
    suspend fun getCreatorWarehouse(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/pricerule/")
    suspend fun getPriceRule(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/products/get")
    suspend fun getProducts(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/shop/get")
    suspend fun getShopInfo(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/collections/list")
    suspend fun listCollections(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/pricerule/list")
    suspend fun listPriceRules(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/products/list")
    suspend fun listProducts(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/shop/shippingcountries/list")
    suspend fun listShopShippingCountries(): Response<kotlin.Any>
     ...
     */
    @POST("api/cms/v3/creatorwarehouse/save")
    suspend fun saveCreatorWarehouse(): Response<kotlin.Any>
