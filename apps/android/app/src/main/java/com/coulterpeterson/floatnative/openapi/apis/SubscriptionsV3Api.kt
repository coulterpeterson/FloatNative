...
interface SubscriptionsV3Api {
    ...
    @POST("api/v3/user/subscribed")
    suspend fun doesUserHaveSubV3(): Response<kotlin.Any>
     ...
     *  - 0: Unexpected response code
     *
     * @return [kotlin.collections.List<UserSubscriptionModel>]
     */
    @GET("api/v3/user/subscriptions")
    suspend fun listUserSubscriptionsV3(): Response<kotlin.collections.List<UserSubscriptionModel>>
