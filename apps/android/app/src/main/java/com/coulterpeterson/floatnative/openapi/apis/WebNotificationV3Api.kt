...
interface WebNotificationV3Api {
    /**
     ...
     */
    @GET("api/v3/push/web/info")
    suspend fun getAppInfoV3(): Response<kotlin.Any>
     ...
     */
    @POST("api/v3/push/web/register")
    suspend fun registerV3(): Response<kotlin.Any>
     ...
     */
    @POST("api/v3/push/web/revoke")
    suspend fun unregisterV3(): Response<kotlin.Any>
