...
public struct ContentPictureV3Response: Codable, JSONEncodable, Hashable {

    public enum UserInteraction: String, Codable, CaseIterable {
        case like = "like"
...
extension ContentPictureV3Response: Identifiable {}
